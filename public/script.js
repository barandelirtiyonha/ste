...
function copyTextToClipboard(text) {
  if (!navigator.clipboard) {
    fallbackCopyTextToClipboard(text.replace(new RegExp("&gt;", "g"), ">").replace(new RegExp("&lt;", "g"), "<"));
    return;
  }
  navigator.clipboard.writeText(text.replace(new RegExp("&gt;", "g"), ">").replace(new RegExp("&lt;", "g"), "<")).then(function() {
